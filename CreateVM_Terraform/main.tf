...
data "vsphere_datacenter" "dc" {
    name = "MVRC-DC"                        # Name of the datacenter to use
}
...
data "vsphere_compute_cluster" "cluster" {
    name = "Xeon" 
    datacenter_id = data.vsphere_datacenter.dc.id # Datacenter ID fetched from the datacenter data source                           # Name of the compute cluster to use
} 
...
data "vsphere_network" "network" {
    name          = "VM Network"              # Name of the network to use
    datacenter_id = data.vsphere_datacenter.dc.id # Datacenter ID fetched from the datacenter data sour
}    
